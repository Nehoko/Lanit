...
<div>
    <form method="post" action="${path}">
        ...
        <p><input type="number" name="address" value="${theater.address!}" placeholder="Адрес"/></p>

        <p><label><input type="number" name="inbox" value="${theater.inbox!}">Почтовый индекс</label></p>
